...
class PreCourse extends StatefulWidget {
  ...
  PreCourse({Key key,this.titleText}) : super(key: key);
          ...
          children: [
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("Why you should take this course?",style: paraText.copyWith(color: Color(0xff1c2031),fontSize: 18,fontWeight: FontWeight.w600)),
                  SizedBox(
                    height: 0.01*height,
                  ),
                  ...
                  Text("What Will you Learn",style: paraText.copyWith(color: Color(0xff1c2031),fontSize: 18,fontWeight: FontWeight.w600)),
                  SizedBox(
                    height: 0.01*height,
                  ),
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>PostCourse(
                ...
                child: Container(
                  ...
                  child: Center(child: Text("Enroll this course",style: paraText.copyWith(fontSize: 20,fontWeight: FontWeight.w500),)),
                ),
              ),
            ),
          ],
