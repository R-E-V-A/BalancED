...
import 'package:resolvers/Screens/SingleCourse/LearningPage.dart';

class PostCourse extends StatefulWidget {
  final String titleText;
  PostCourse({Key key,this.titleText}) : super(key: key);
  @override
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text("Back",style: paraText.copyWith(color: Colors.black,fontSize: 20),)
                    ],
                  ),
                  SizedBox(
                    height: 0.04*height,
                  ...
                  Text("Learn to budget your expenses.",style: paraText.copyWith(color: Color(0xff9c9c9c),fontSize: 15,),),
                  SizedBox(
                    height: 0.02*height,
                  ),
                  Text("Lessons",style: paraText.copyWith(color: Color(0xff1c2031),fontSize: 18,fontWeight: FontWeight.w600)),
                  GridView.builder(
                    scrollDirection: Axis.vertical,
                    shrinkWrap: true,
                    itemCount: 8,
                      ...
                      if(index==0)
                        {
                          return Card(
                            ...
                            color: Color(0xff22319e),
                            child: Padding(
                              padding: EdgeInsets.only(left: 0.08*width,top:0.02*height),
                              child: Text("1",style: paraText.copyWith(color: Colors.white,fontSize: 30),),
                            )
                          );
                        }
                      return Card(
                        ...
                        color: Colors.white,
                        child: Icon(Icons.lock,color: Color(0xff22319e),),
                      );
                    },
                  ),
                  SizedBox(
                  ...
                  Text("Additional Resources",style: paraText.copyWith(color: Color(0xff1c2031),fontSize: 18,fontWeight: FontWeight.w600)),
                  SizedBox(
                    height: 0.01*height,
                  ),
            ...
            Positioned(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: Center(child: Text("Continue Learning",style: paraText.copyWith(fontSize: 20,fontWeight: FontWeight.w500),)),
                ),
              ),
            ),
          ],
