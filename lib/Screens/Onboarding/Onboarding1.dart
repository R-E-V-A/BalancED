        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text("Start your journey with fun learning content",style: paraText.copyWith(fontWeight: FontWeight.w500,fontSize: 20,color: Color(0xff0d0f44)),textAlign: TextAlign.center,),
              SizedBox(
                height: 0.02*height,
              ),
              Padding(
