        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Image.asset("assets/Layer 3.png",height: height*0.48,width: width*0.7,color: Colors.transparent,colorBlendMode: BlendMode.multiply,),
              SizedBox(
                height: 0.02*height,
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Icon(Icons.circle,color: Color(0xff22319e),size: 10,),
                  SizedBox(width: 0.02*width,),
                  Icon(Icons.circle,color: Colors.white,size: 10,),
                ],
              ),
